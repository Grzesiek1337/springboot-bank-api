...
public class TransferService {
    ...
    @Transactional
    public void transferMoney(String fromAccountNumber, String toAccountNumber, Money amount) throws InsufficientFundsException, InvalidAccountNumberException {
        ...
        Money moneyAmount = new Money(amount.getAmount());
